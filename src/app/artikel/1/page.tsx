...
import { BookOpen, Search, Bell, Calendar, User, Clock, ArrowLeft, Tag, Share2, Bookmark, ThumbsUp } from 'lucide-react';
...
export default function ArtikelReadPage() {
  const relatedArticles = [
    {
      id: 1,
      title: "Motivation Letter vs Personal Statement: Apa Bedanya",
      readTime: "9 menit",
      image: "✍️"
    },
    {
      id: 2,
      title: "5 Kesalahan Fatal Saat Apply Beasiswa",
      readTime: "5 menit",
      image: "⚠️"
    },
    {
      id: 3,
      title: "Cara Mempersiapkan Interview Beasiswa",
      readTime: "10 menit",
      image: "💼"
    }
  ];
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="ml-64 flex-1">
        ...
        {/* Article Header */}
        <div className="bg-gradient-to-r from-yellow-400 to-orange-500 px-8 py-12 text-white">
