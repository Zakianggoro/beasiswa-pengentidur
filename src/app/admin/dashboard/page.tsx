...
export default function AdminDashboard() {
  ...
  const [activePanel, setActivePanel] = useState<'tambah' | 'hapus'>('tambah');
          ...
          <>
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-6">
              ...
              <p className="text-gray-600">
                Tambahkan data beasiswa baru ke database
              </p>
            </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 max-w-3xl mx-auto">
                <div className="space-y-6">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="w-full flex items-center justify-center gap-2 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition disabled:opacity-50"
                  >
          ...
          <>
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-6 flex items-center justify-between flex-wrap gap-3">
              <div>
                ...
                <p className="text-gray-600">
                  Kelola dan hapus data beasiswa dari database
                </p>
              </div>
              <button
            ...
            <div className="p-6">
              <div className="bg-white rounded-xl p-6 border border-gray-200 max-w-5xl mx-auto">
                <input
                  ...
                  className="w-full mb-6 px-4 py-3 border text-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                />

                {filteredBeasiswa.length === 0 ? (
                  <p className="text-gray-500 text-center py-8">
                    {search ? 'Tidak ada beasiswa yang cocok dengan pencarian.' : 'Tidak ada beasiswa ditemukan.'}
                  </p>
                ) : (
                  <div className="space-y-2">
                    {filteredBeasiswa.map((b) => (
                      <div
                        key={b.id}
                        className="flex items-center justify-between py-4 px-4 hover:bg-gray-50 transition rounded-lg border border-gray-100"
                      >
                ...
                <div className="mt-6 pt-4 border-t border-gray-200 text-sm text-gray-600 text-center">
                  Total: {filteredBeasiswa.length} beasiswa
                </div>
              </div>
            </div>
          </>
